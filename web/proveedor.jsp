                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <sj:tabbedpanel id="tabs" cssClass="list">
                                <sj:tab id="lista_materiales" target="tabListaMateriales" label="lista de Proveedores" />
                                <sj:tab id="ingreso_materiales" target="tabIngresarMateriales" label="Ingresar Proveedores"/>
                                <sj:tab id="modificacion_materiales" target="tabModificarMateriales" label="Modificar Proveedores" ondblclick=""/>    
                                ...
                                <div id="tabIngresarMateriales">                          
                                    <s:form action="ingresarProveedor" theme="bootstrap" label="Ingrese los datos" >
